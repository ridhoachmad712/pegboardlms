        ...
        <div class="card-body">
            <div class="d-flex align-items-start">
                ...
                <div class="me-auto">
                    ...
                    @if ($isAdmin)
                        <p class="text-secondary mb-2">Mulai cepat: kelola <strong>Dosen &amp; Mahasiswa</strong>, atur <strong>Semester, Tampilan, dan Backup</strong> dari Panel Admin. Anda juga bisa mengajar lewat Ruang mengajar.</p>
                    @elseif ($isDosen)
                    ...
                    <div class="btn-list">
                        ...
                        @if ($isAdmin)
                            <a href="{{ route('admin.dashboard') }}" class="btn btn-sm"><i class="ti ti-shield-check me-1"></i>Panel Admin</a>
                        @else
